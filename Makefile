...
SRC = main.tex
BUILD_DEP = $(wildcard *.tex) $(wildcard sections/*.tex) $(wildcard texenv/*.tex) $(wildcard figures/*) $(wildcard tables/*) bibliography.bib
...
dirs:
	@mkdir -p $(BUILD_DIR)
	@mkdir -p $(BUILD_DIR)/sections $(BUILD_DIR)/texenv
